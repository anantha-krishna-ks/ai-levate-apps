  ...
  const aiTools = [
    {
      ...
      description: "Generate high-quality subjective and objective questions instantly from your source content using AI.",
    ...
    },
    {
      id: "item-writer",
      title: "Item Writer",
      description: "Craft well-structured objective questions tailored to your learning objectives in seconds.",
      path: "/item-writer",
    ...
    },
    {
      id: "item-metadata",
      title: "Item Metadata",
      description: "Auto-tag questions with topic, difficulty, and Bloom's level using AI-driven metadata enrichment.",
      path: "/item-metadata",
    ...
    },
    {
      ...
      description: "Build complete courses with modules, lessons, and assessments guided by an AI co-pilot.",
    ...
    },
    {
      id: "item-rewriter",
      title: "Item Rewriter",
      description: "Refresh and rephrase existing questions to improve clarity, fairness, and engagement.",
      path: "/item-rewriter",
    ...
    },
    {
      ...
      description: "Detect duplicate or near-identical questions across your bank with AI similarity scoring.",
    ...
    },
    {
      ...
      title: "Course Generator",
      description: "Plan, draft, and structure full courses end-to-end with intelligent content suggestions.",
    ...
    },
    {
      ...
      description: "Generate rich, real-world scenarios and case-based items for higher-order assessments.",
      path: "/scenario",
    ...
    },
    {
      ...
      description: "Chat directly with NCERT textbooks and get instant, source-grounded answers to your queries.",
      path: "/doc-chat-ncert",
      image: docChatImage,
      category: "Education",
      icon: MessageSquare,
    ...
    },
    {
      ...
      description: "Query the Moby-click reference library and verify content with conversational AI.",
      path: "/doc-chat-moby",
      image: docChatImage,
      category: "Education",
      icon: MessageSquare,
    ...
    },
    {
      id: "ocr",
      title: "OCR",
      description: "Extract clean, searchable text from images, scans, and PDFs with high-accuracy OCR.",
      path: "/ocr",
      image: ocrImage,
      category: "AI Tools",
      badge: "New",
    ...
    },
    {
      ...
      description: "Evaluate handwritten answer sheets end-to-end with AI-powered segmentation, OCR, and scoring.",
      path: "/ocr-evaluation",
    ...
    },
    {
      ...
      description: "Score subjective answers against curated rubrics with rich, personalized AI feedback.",
    ...
    },
    {
      ...
      description: "Evaluate open-ended essays without prior training using zero-shot AI assessment.",
    ...
    },
    {
      ...
      description: "Uncover insights into test integrity, item performance, and learner behavior with deep analytics.",
      path: "/test-forensics",
      image: comingSoonImage,
      category: "Analytics",
      icon: BarChart,
    ...
    },
    {
      ...
      description: "Turn your ideas into stunning visuals with Stable Diffusion-powered image generation.",
    ...
    },
    {
      id: "ai-persona",
      title: "AI Persona",
      description: "Engage in immersive dialogues with AI personas of famous thinkers and historical figures.",
      path: "/ai-persona",
      image: comingSoonImage,
    ...
    },
    {
      ...
      description: "Assess reading fluency and speaking proficiency with real-time AI-driven speech analysis.",
              ...
              return (
                <button
                  ...
                  className={`px-4 h-9 rounded-full whitespace-nowrap text-sm font-medium tracking-tight transition-all duration-200 border ${
                    isActive
                      ? "bg-primary text-primary-foreground border-[hsl(var(--primary-700))] shadow-[0_1px_2px_rgba(0,0,0,0.06),0_4px_12px_-2px_hsl(var(--primary)/0.25)]"
                      : "bg-background/80 backdrop-blur text-foreground/80 border-[hsl(var(--gray-300))] hover:text-foreground hover:bg-foreground/[0.04]"
                  }`}
                >
                  {tab}
                </button>
